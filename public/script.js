(() => {
  ...
  // The sticky header is always visible, so targeting the header itself would not
  // reliably move the document. Home brand links explicitly return to scrollY=0.
  $$('a.brand[href="#accueil"]').forEach((link) => {
