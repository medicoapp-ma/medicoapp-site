(() => {
  ...
  const localSection = $('#donnees-locales');
  ...
  const updateChrome = () => {
    ...
    if (siteHeader && localSection) {
      const headerHeight = siteHeader.getBoundingClientRect().height;
      const localBounds = localSection.getBoundingClientRect();
      const overlapsDarkSection = localBounds.top <= headerHeight && localBounds.bottom > headerHeight;
      siteHeader.classList.toggle('is-over-dark', overlapsDarkSection);
    }
  };
